...
function Tables() {
  const Heading = [
    ...
    },
    {
      ...
      render: (a: any) => (
        <div
          className={
            a === "Accepted"
              ? "bg-[green] text-[16px] text-green-200 p-1 rounded-md font-medium w-fit flex gap-2 items-center"
              : "bg-[red] text-[16px]  text-red-200 p-1 rounded-md font-medium w-fit flex gap-2 items-center"
          }
        >
          {a === "Accepted" ? (
    ...
    },
    {
      ...
      index: "details",
      render: (a: any) => (
        <div className="text-white-500 flex gap-1 text-[16px] cursor-pointer">
